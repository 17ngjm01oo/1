...
FINANCE_PAGE_CONFIGS = (
    ...
    CountryPageConfig(
        page_kind="government-revenue-spending",
        title_suffix="Government Revenue and Spending",
        chart_title="Government Revenue and Spending Chart by Country",
        subtitle=GOVERNMENT_REVENUE_EXPENDITURE_SUBTITLE,
        generated_label="government revenue and spending",
        source_note=WEO_COUNTRY_SOURCE_NOTE,
        data_note=WEO_COUNTRY_DATA_NOTE,
        related_nav_label="Finance page navigation",
        indicators=(
            ...
            IndicatorBlockConfig(
                series_id="governmentSpending",
                title="Government Spending",
                canvas_label="Government spending line chart",
                display_unit="% of GDP",
                compare_label="Government Spending (% of GDP)",
            ),
            IndicatorBlockConfig(
                series_id="governmentSpendingNational",
                title="Government Spending",
                canvas_label="Government spending in national currency line chart",
                display_unit="Local currency",
            ),
        ),
    ),

...
def main() -> None:
    ...
    for country in countries:
        page_dir = OUTPUT_DIR / country["slug"] / "gdp-growth"
        page_dir.mkdir(parents=True, exist_ok=True)
        (page_dir / "index.html").write_text(render_page(country), encoding="utf-8")

    print(f"Generated {len(countries)} GDP growth country pages.")
...
<html lang="en">
  <head>
    ...
    <title>{country_name} Real GDP Growth Rate</title>
    <link rel="stylesheet" href="../../../styles.css" />
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js" defer></script>
    <script type="module" src="../../../src/countryIndicatorPage.js"></script>
  </head>
  <body data-country-code="{country_code}" data-page-kind="gdp-growth">
    ...
    <main class="page-shell">
      ...
      <section class="hub-section" aria-labelledby="country-hub-title">
        <header class="page-header">
          <h1 id="country-hub-title" class="page-title">GDP Growth Rate Chart by Country</h1>
          <p class="subtitle">Select a country to view historical GDP growth rate trends.</p>
      ...
      <section class="indicators-section" aria-labelledby="country-data-title">
        <div class="indicators-card">
          ...
          <section class="indicator-block" aria-labelledby="gdpGrowth-title">
            ...
            <div class="chart-card" id="gdpGrowthChartCard">
              <canvas id="gdpGrowthChart" aria-label="Real GDP Growth Rate line chart" role="img"></canvas>
              <div class="chart-overlay" id="gdpGrowthOverlay" aria-hidden="true"></div>
            </div>

            <details class="data-table-toggle" id="gdpGrowthTableToggle">
              <summary>Show data table</summary>
              <div class="data-table-wrap" id="gdpGrowthTableWrap"></div>
            </details>
          </section>

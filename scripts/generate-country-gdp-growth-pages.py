  ...
  <body data-country-code="{country_code}" data-page-kind="gdp-growth">
    <main class="page-shell">
      <section class="top-nav-card" aria-label="Site navigation">
        <nav class="site-nav">
          <a href="../../../">Home</a>
          <a href="../../../rankings/real-gdp-growth/world/">Real GDP Growth Ranking</a>
        </nav>
      </section>

      <section class="hub-section" aria-labelledby="country-hub-title">
        <header class="page-header">
          <h1 id="country-hub-title" class="page-title">GDP Growth Rate by Country</h1>
          <p class="subtitle">Choose a country to view GDP Growth Rate indicators.</p>

...
def main() -> None:
    ...
    for country in countries:
        page_dir = OUTPUT_DIR / country["slug"] / "ppp"
        page_dir.mkdir(parents=True, exist_ok=True)
        (page_dir / "index.html").write_text(render_page(country), encoding="utf-8")

    print(f"Generated {len(countries)} PPP country pages.")
...
<html lang="en">
  <head>
    ...
    <title>{country_name} PPP</title>
    <link rel="stylesheet" href="../../../styles.css" />
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js" defer></script>
    <script type="module" src="../../../src/countryIndicatorPage.js"></script>
  </head>
  <body data-country-code="{country_code}" data-page-kind="ppp">
    <main class="page-shell">
      ...
      <section class="hub-section" aria-labelledby="country-hub-title">
        <header class="page-header">
          <h1 id="country-hub-title" class="page-title">PPP by Country</h1>
          <p class="subtitle">Choose a country to view PPP indicators from the IMF World Economic Outlook.</p>
        </header>
        ...
        <div class="indicators-card">
          <header class="page-header country-data-header">
            ...
            <nav class="site-nav" id="countryRelatedPageNav" aria-label="Country page navigation">
              ...
              <a href="../ppp-per-capita/">View PPP per capita</a>
            </nav>
          </header>
          ...
          <section class="indicator-block" aria-labelledby="ppp-title">
              ...
              <div class="compare-control" data-series-id="ppp">
                <div class="compare-input-wrap">
                  <input
                    ...
                    aria-controls="pppCompareResults"
                    role="combobox"
                    aria-autocomplete="list"
                    aria-expanded="false"
                  />
            ...
            <div class="chart-card" id="pppChartCard">
              <canvas id="pppChart" aria-label="PPP line chart" role="img"></canvas>
              <div class="chart-overlay" id="pppOverlay" aria-hidden="true"></div>
            </div>

            <details class="data-table-toggle" id="pppTableToggle">
              <summary>Show data table</summary>
              <div class="data-table-wrap" id="pppTableWrap"></div>
            </details>
          </section>
